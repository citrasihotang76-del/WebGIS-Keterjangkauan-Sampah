...
map.getView().fit([11147297.412980, -126638.845988, 11194912.497627, -80851.842265], map.getSize());
...
var Title = new ol.control.Control({
    element: (() => {
        ...
        titleElement.innerHTML = '<h2 class="project-title">WebGIS Peta Keterjangkauan Sampah Kota Padang</h2>';
        return titleElement;
    })(),
    ...
    element: (() => {
        ...
        if (1392 > 240) {
            ...
            window.showAbstract = function() {
                ...
                linkElement.innerHTML = 'Penelitian ini mengembangkan sebuah WebGIS Interaktif untuk memetakan dan menganalisis tingkat keterjangkauan layanan Tempat Penampungan Sementara (TPS) bagi permukiman masyarakat di Kota Padang. Metodologi utama menggunakan analisis buffering (penyanggaan) berbasis jarak Euclidean pada perangkat lunak QGIS. Tiga zona keterjangkauan didefinisikan dengan membuat buffer dari titik lokasi TPS pada radius 100 meter (Sangat Dekat), 250 meter (Cukup Dekat), dan 500 meter (Masih Terjangkau).<br /><br />Data spasial yang diintegrasikan sangat komprehensif, meliputi: jaringan jalan (Arteri, Lokal, Setapak), titik TPS dengan atribut detail (jenis, estimasi populasi yang dilayani, jam operasional, dan status retribusi), serta poligon wilayah permukiman masyarakat. Estimasi cakupan layanan dianalisis dengan melakukan overlay antara ketiga zona buffer tersebut dengan data poligon permukiman.<br /><br />Hasil analisis divisualisasikan dalam platform WebGIS yang memungkinkan eksplorasi interaktif. Pengguna dapat melihat sebaran TPS, menyalakan/mematikan layer zona keterjangkauan (100m, 250m, 500m), serta mengidentifikasi area permukiman yang masih berada di luar jangkauan layanan. Aplikasi ini dirancang sebagai alat bantu keputusan bagi dinas terkait untuk mengevaluasi kinerja layanan existing, menentukan prioritas pembangunan TPS baru, dan merencanakan distribusi layanan yang lebih merata dan efektif.<br /><br />';
            }
